...
namespace EOM.Web.Migrations
{
    ...
    [Migration("20250711122630_AddHRTablesAndRemoveQuota")]
    partial class AddHRTablesAndRemoveQuota
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EOM.Web.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("EOM.Web.Models.DepartmentQuota", b =>
                {
                    ...
                    b.HasOne("EOM.Web.Models.Department", null)
                        .WithMany("DepartmentQuotas")
            ...
            modelBuilder.Entity("EOM.Web.Models.Employee", b =>
                {
                    b.HasOne("EOM.Web.Models.Department", "Department")
                        .WithMany("Employees")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
