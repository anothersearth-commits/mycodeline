...
namespace EOM.Web.Migrations
{
    ...
    [Migration("20250805043811_AddSelfNominationSupport")]
    partial class AddSelfNominationSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EOM.Web.Models.AttendanceRecord", b =>
                {
                    ...
                    b.Property<string>("AttendanceIn")
                        .HasColumnType("VARCHAR2(8)")
                        .HasColumnName("ATT_IN");

                    b.Property<string>("AttendanceOut")
                        .HasColumnType("VARCHAR2(8)")
                        .HasColumnName("ATT_OUT");

                    b.Property<string>("Difference")
                        .HasColumnType("VARCHAR2(8)")
                        .HasColumnName("DIFF");

                    b.HasKey("EmployeeNumber", "AttendanceDate");

                    b.ToTable("VW_EOM_ATTENDANCE");

                    b.ToView("VW_EOM_ATTENDANCE", (string)null);
                });
            ...
            modelBuilder.Entity("EOM.Web.Models.AwardType", b =>
                {
                    ...
                    b.Property<bool>("IsSelfNomination")
                        .HasColumnType("NUMBER(1)");
            ...
            modelBuilder.Entity("EOM.Web.Models.Evaluation", b =>
                {
                    ...
                    b.HasIndex("NominationId", "CommitteeMemberId")
                        .IsUnique()
            ...
            modelBuilder.Entity("EOM.Web.Models.GroupNominationMember", b =>
                {
                    ...
                    b.HasIndex("NominationId", "EmployeeId")
                        .IsUnique()
                        .HasDatabaseName("UQ_GroupNom_Nom_Emp");

                    b.ToTable("GROUPNOMINATIONMEMBERS", (string)null);
                });
